...
static const RISCVSupportedExtension SupportedExtensions[] = {
    ...
    {"zvl65536b", {1, 0}},
    {"zvl8192b", {1, 0}},
    // from zeno: LLVM 19 modified function signature to check for extension
    // (Crosscheck with file at 'clang/lib/Driver/ToolChains/Arch/RISCV.cpp')
    {"zzeno", {0, 1}},
};
...
static const RISCVSupportedExtension SupportedExperimentalExtensions[] = {
    ...
    {"zvfbfmin", {1, 0}},
    {"zvfbfwma", {1, 0}},
//from zeno: LLVM 19 modified function signature to check for extension (Crosscheck with file at 'clang/lib/Driver/ToolChains/Arch/RISCV.cpp')
   {"zzeno", {0, 1}},
};
// clang-format on
