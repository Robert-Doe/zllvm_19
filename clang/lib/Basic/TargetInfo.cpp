...
const char *TargetInfo::getTypeConstantSuffix(IntType T) const {
  ...
  case UnsignedLongLong: return "ULL";
    //zeno belief: I believe what is below has some issues because of an oversight.
  // I feel UnsignedIntNS should return "UN" instead of just "N"
...
unsigned TargetInfo::getTypeWidth(IntType T) const {
  ...
  case SignedIntNS:
  case UnsignedIntNS:    return getPointerWidth(LangAS::Default);
  };
}
...
TargetInfo::IntType TargetInfo::getIntTypeByWidth(
  ...
  //from zeno
  if(getPointerWidth(LangAS::Default) == BitWidth)
...
unsigned TargetInfo::getTypeAlign(IntType T) const {
  ...
  case SignedIntNS:
  case UnsignedIntNS:    return getPointerAlign(LangAS::Default);
  };
}
