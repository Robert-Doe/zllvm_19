...
static bool getArchFeatures(const Driver &D, StringRef Arch,
  ...
  //from zeno:  checkout the definition of the function toFeatures overhere to better understand it:
  //https://llvm.org/doxygen/RISCVISAInfo_8cpp_source.html
  /*
   * It adds all the extensions passed along in argument.
   *
   */
